    ...
    <div>
        <div class="flex justify-between mb-4 items-center">
            <h2 class="font-semibold text-3xl">
                Danh sách phiếu khai báo toàn dân
            </h2>
...
<script>
    ...
    import Table from '@/components/admin/form/national/Table.vue';
    import { getNationalSheets } from '@/api/user';

    export default {
        components: { Table },

        async asyncData() {
            const { data: { sheets } } = await getNationalSheets();
            return {
                sheets,
            };
        },
